  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className=" mx-auto mt-12  w-full max-w-screen-2xl">
        <section className="bg-[#E8F3EA] px-6 rounded-lg py-24">
          <div className="container">
            <div className="grid gap-8 lg:grid-cols-2">
              <div className="flex flex-col justify-center space-y-4">
                <h1 className="text-4xl font-bold tracking-tight text-green-600 lg:text-5xl">
              ...
              <div className="flex items-center justify-center lg:justify-end">
                <img
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/MacBook%20Pro%2014_%20-%2018-fz8Vfbyxk25FsNtji0qJqQUeWSsNYN.png"
                  alt="Chef"
